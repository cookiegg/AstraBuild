...
| Coverage transition | selected >1 m samples 78.8%→14.6%; GIS-B 8.12→0.15 m; transformer 3.15→0.06 m | `presentation/report/技术报告.md` B25/B26 case | Omission/coverage accounting | Independent absolute geometric error |

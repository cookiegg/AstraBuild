...
当前 `/data/proj/xunjian-copilot/experiments/blender-substation/photo-first-pilot/output/installation_B34/site_B34_ground_roads_perimeter.blend`，SHA256 `225985c7898f4ac3ea550df9a3d8ef8d2300e460d953891600dc62489c4fda8d`。独立组件 `/data/proj/xunjian-copilot/experiments/blender-substation/photo-first-pilot/output/installation_B34/B34_site_civil_components.blend`。B34整体重读、历史保持、组件重读、相机包络、129处基础接缝通过；GUIdirtyFalse，主变共享。默认713，716俯视，719入口，722东南，725单独土建。

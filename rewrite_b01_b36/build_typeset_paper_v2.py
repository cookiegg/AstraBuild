...
MD = ROOT / '20_FULL_MANUSCRIPT_FIGURE_V2.md'
TEX = ROOT / 'paper_layout_v2.tex'
PDF = ROOT / 'paper_layout_v2.pdf'
...
figure_specs = {
    1: ('figure_v2/hybrid_pdf/fig01_overview_v2.pdf', 0.285, 'fig:overview'),
    ...
    4: ('figure_v2/hybrid_pdf/fig04_transitions_v2.pdf', 0.335, 'fig:transitions'),
    5: ('figure_v2/hybrid_pdf/fig05_persistence_v2.pdf', 0.300, 'fig:persistence'),
}
...
\vspace{{0.45em}}
{{\small Advisor-discussion draft · B01--B36 figure-v2 version\par}}
\end{{center}}
\vspace{{0.35em}}
\begin{{abstract}}
{abstract_tex}

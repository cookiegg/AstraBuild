...
MD = ROOT / '21_FULL_MANUSCRIPT_FIGURE_V22.md'
TEX = ROOT / 'paper_layout_v22.tex'
PDF = ROOT / 'paper_layout_v22.pdf'
...
figure_specs = {
    1: ('figure_v22/hybrid_pdf/fig01_overview_v22.pdf', 0.340, 'fig:overview'),
    ...
    4: ('figure_v22/hybrid_pdf/fig04_transitions_v22.pdf', 0.440, 'fig:transitions'),
    5: ('figure_v22/hybrid_pdf/fig05_persistence_v22.pdf', 0.420, 'fig:persistence'),
}
...
\vspace{{0.45em}}
{{\small Advisor-discussion draft · B01--B36 figure-v2.2 version\par}}
\end{{center}}
\vspace{{0.35em}}
\begin{{abstract}}
{abstract_tex}

...
def build_fig5():
    ...
    top=[
        ...
        (726,110,300,"B29","conductors reuse prior clamps and endpoints","jumpers and crossyard conductors connect previously modeled subsystems",hist("installation_B29/600_B29_G220_OUT_Detail_Overlay.png"),SOFT_ORANGE,ORANGE),
